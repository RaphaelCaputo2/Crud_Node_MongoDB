...
- _Query_ de Autenticação:<br>
  <http://localhost:3000/auth/authenticate>

- _Query_ de Forgot Password:<br>
  <http://localhost:3000/auth/forgot_password>\*
- _Query_ de Reset Password:<br>
  <http://localhost:3000/auth/reset_password>\*

- _Query_ de listar todos os projeto:<br>
...
### Inicie o insomnia, clique em _New Workspace_ e escolha o nome do seu _Workspace_
...
#### Feito isso, vamos a configuração da nossa requisição, nossa _BASEURL_ que criamos, um pouco acima, o caminho vai ser:
